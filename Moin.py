...
bot = telebot.TeleBot('7757010456:AAG17mWIWVI757SyKc9gBOBM3ZBXV9NuKPQ')
...
def show_main_buttons(message):
    ...
    bot.send_message(message.chat.id, "🔹 zodvik DDOS BOT 🔹", reply_markup=markup)
...
def handle_buy_coins(message):
    ...
    if user_id in admin_id:
        ...
        bot.reply_to(message, "💰 𝗗𝗠 𝗧𝗢 𝗕𝗨𝗬 𝗖𝗢𝗜𝗡𝗦 @@N9MANxHERO")
